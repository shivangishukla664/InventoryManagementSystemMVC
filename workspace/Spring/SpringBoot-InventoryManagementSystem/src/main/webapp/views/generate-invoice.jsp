...
<p style="font-family: Californian FB;">Email: aashi.111@gmail.com</p>	
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-lg-12">
							<label for="price1" style="font-family: Californian FB;">Total Price</label>
								<input type="text" name="price1" value=${order1.price1} placeholder="Enter Product Price" Class="form-control" />
							</div>
						</div>
